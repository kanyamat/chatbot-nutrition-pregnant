...
########################################################################################################################################################   
    ...
    $q = pg_exec($dbconn, "INSERT INTO sequentsteps(sender_id,seqcode,answer,nextseqcode,status,created_at,updated_at )VALUES('{$user_id}','0019',/*'{$u}'*/$_msg,'0021','0',NOW(),NOW())") or die(pg_errormessage());
