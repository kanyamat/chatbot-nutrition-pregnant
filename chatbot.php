 ...
 // }elseif (strlen($_msg) == 5 && $seqcode == "0008") {
    ...
    $month  = str_replace("","",$pieces[1]);
      ...
      $url = 'https://api.line.me/v2/bot/message/reply';
         ...
         curl_close($ch);
         echo $result . "\r\n";
    $q = pg_exec($dbconn, "INSERT INTO sequentsteps(sender_id,seqcode,answer,nextseqcode,status,created_at,updated_at )VALUES('{$user_id}','00014', $week_preg ,'0015','0',NOW(),NOW())") or die(pg_errormessage());


 }elseif ($event['message']['text'] == "อายุครรภ์ถูกต้อง" && $seqcode == "0014" ) {
