...
// (15, '0015', 'ขอทราบครั้งสุดท้ายที่คุณมีประจำเดือนเพื่อคำนวณอายุครรภ์ค่ะ (กรุณาตอบวันที่และเดือนเป็นตัวเลขนะคะ เช่น 17 04 คือ วันที่ 17 เมษายน)', NULL, 2, '0016', NULL, NULL),
...
// (19, '0019', 'ขอทราบชื่อโรงพยาบาลที่คุณแม่ไปฝากครรภ์หน่อยค่ะ', NULL, 2, '0020', NULL, NULL),

// (20, '0020', 'ชื่อโรงพยาบาลที่คุณแม่ไปฝากครรภ์คือ', 'ใช่ไหมคะ ถ้าไม่ถูกต้องกรุณาพิมพ์ชื่อโรงพยาบาลของคุณใหม่ค่ะ', 3, '0021', NULL, NULL),

// (21, '0021', 'ขอทราบเลขประจำตัวผู้ป่วยของโรงพยาบาลที่คุณแม่ไปฝากครรภ์หน่อยค่ะ', NULL, 2, '0022', NULL, NULL),

// (22, '0022', 'เลขประจำตัวผู้ป่วยของโรงพยาบาลที่คุณแม่ไปฝากครรภ์คือ ', 'ใช่ไหมคะ ถ้าไม่ถูกต้องกรุณาพิมพ์เลขประจำตัวผู้ป่วยของคุณใหม่ค่ะ', 3, '0023', NULL, NULL),

// (23, '0023', 'คุณมีประวัติการแพ้ยาหรืออาหารไหมคะ', NULL, 2, '1001', NULL, NULL),

// (24, '0024', 'คุณแพ้ยาอะไรคะ', NULL, 2, '1001', NULL, NULL),

// (25, '0024', 'คุณแพ้อาหารอะไรคะ', NULL, 2, '1001', NULL, NULL),

// (26, '1001', 'ขอบคุณสำหรับข้อมูลนะคะ', NULL, 2, '1002', NULL, NULL),

// (27, '1002', 'หากอยากให้ทางเราช่วยอะไร ท่านสามารถเลือกได้ตามหัวข้อด้านล่างเลยค่ะ', NULL, 2, NULL, NULL, NULL)
// ";
