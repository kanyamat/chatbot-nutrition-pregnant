...
(3, '0003', 'ก่อนอื่น ดิฉันขอทราบชื่อและนามสกุลของว่าที่คุณแม่หน่อยนะคะ', NULL, 1, '0004', NULL, NULL),

(4, '0005', 'หากคุณสนใจให้ดิฉันเป็นผู้ช่วยอัตโนมัติของคุณ โปรดกดยืนยันด้างล่างด้วยนะคะ', NULL, 3, '0006', NULL, NULL),

(5, '0006', 'ก่อนอื่น ดิฉันขอทราบชื่อและนามสกุลของว่าที่คุณแม่หน่อยนะคะ', NULL, 2, '0007', NULL, NULL),

(6, '0007', 'ชื่อของคุณคือ', 'ใช่ไหมคะ? ถ้าไม่ถูกต้องกรุณาพิมพ์ชื่อของคุณใหม่อีกครั้งนะคะ', 3, '0008', NULL, NULL),

(7, '0008', 'ขอทราบอายุของคุณหน่อยค่ะ ', NULL, 2, '0009', NULL, NULL),

(8, '0009', 'คุณอายุ', 'ปี ใช่ไหมคะ ถ้าไม่ถูกต้องกรุณาพิมพ์อายุของคุณใหม่ค่ะ', 3, '0010', NULL, NULL),

(9, '0010', 'ขอทราบส่วนสูงปัจจุบันของคุณค่ะ (กรุณาตอบเป็นตัวเลขในหน่วยเซ็นติเมตร เช่น 160)', NULL, 2, '0011', NULL, NULL),

(10, '0011', 'ส่วนสูงปัจจุบันของคุณคือ', 'เซ็นติเมตร ใช่ไหมคะ ถ้าไม่ถูกต้องกรุณาพิมพ์ส่วนสูงของคุณใหม่ค่ะ', 3, '0012', NULL, NULL),

(11, '0012', 'ขอทราบน้ำหนักปกติก่อนตั้งครรภ์ค่ะ (กรุณาตอบเป็นตัวเลขในหน่วยกิโลกรัม เช่น 55)', NULL, 2, '0013', NULL, NULL),

(12, '0013', 'ก่อนตั้งครรภ์คุณมีน้ำหนัก', 'กิโลกรัมใช่ไหมคะ ถ้าไม่ถูกต้องกรุณาพิมพ์น้ำหนักก่อนตั้งครรภ์ของคุณใหม่ค่ะ', 3, '0014', NULL, NULL),

(13, '0014', 'ขอทราบครั้งสุดท้ายที่คุณมีประจำเดือนเพื่อคำนวณอายุครรภ์ค่ะ (กรุณาตอบวันที่และเดือนเป็นตัวเลขนะคะ เช่น 17 04 คือ วันที่ 17 เมษายน)', NULL, 2, '0015', NULL, NULL),

(14, '0015', 'คุณมีอายุครรภ์', 'ใช่ไหมคะ ถ้าไม่ถูกต้องกรุณาพิมพ์วันที่และเดือนครั้งสุดท้ายที่คุณมีประจำเดือนใหม่ค่ะ', 3, '0016', NULL, NULL),

(15, '0016', 'ขอทราบเบอร์โทรศัพท์ของคุณหน่อยค่ะ', NULL, 2, '0017', NULL, NULL),

(16, '0017', 'เบอร์โทรศัพท์ของคุณคือ', 'ใช่ไหมคะ ถ้าไม่ถูกต้องกรุณาพิมพ์เบอร์โทรศัพท์ของคุณใหม่ค่ะ', 3, '0018', NULL, NULL),

(17, '0018', 'ขอทราบชื่อโรงพยาบาลที่คุณแม่ไปฝากครรภ์หน่อยค่ะ', NULL, 2, '0019', NULL, NULL),

(18, '0019', 'ชื่อโรงพยาบาลที่คุณแม่ไปฝากครรภ์คือ', 'ใช่ไหมคะ ถ้าไม่ถูกต้องกรุณาพิมพ์ชื่อโรงพยาบาลของคุณใหม่ค่ะ', 3, '0020', NULL, NULL),

(19, '0020', 'ขอทราบเลขประจำตัวผู้ป่วยของโรงพยาบาลที่คุณแม่ไปฝากครรภ์หน่อยค่ะ', NULL, 2, '0021', NULL, NULL),

(20, '0021', 'เลขประจำตัวผู้ป่วยของโรงพยาบาลที่คุณแม่ไปฝากครรภ์คือ ', 'ใช่ไหมคะ ถ้าไม่ถูกต้องกรุณาพิมพ์เลขประจำตัวผู้ป่วยของคุณใหม่ค่ะ', 3, '0022', NULL, NULL),

(21, '0022', 'คุณมีประวัติการแพ้ยาหรืออาหารไหมคะ', NULL, 2, '1001', NULL, NULL),
