...
// (13, '0013', 'ขอทราบครั้งสุดท้ายที่คุณมีประจำเดือนเพื่อคำนวณอายุครรภ์ค่ะ (กรุณาตอบวันที่และเดือนเป็นตัวเลขนะคะ เช่น 17 04 คือ วันที่ 17 เมษายน)', NULL, 2, '0014', NULL, NULL),

// (14, '0014', 'คุณมีอายุครรภ์', 'ใช่ไหมคะ ถ้าไม่ถูกต้องกรุณาพิมพ์วันที่และเดือนครั้งสุดท้ายที่คุณมีประจำเดือนใหม่ค่ะ', 3, '0015', NULL, NULL),

// (15, '0015', 'ขอทราบเบอร์โทรศัพท์ของคุณหน่อยค่ะ', NULL, 2, '0016', NULL, NULL),

// (16, '0016', 'เบอร์โทรศัพท์ของคุณคือ', 'ใช่ไหมคะ ถ้าไม่ถูกต้องกรุณาพิมพ์เบอร์โทรศัพท์ของคุณใหม่ค่ะ', 3, '0017', NULL, NULL),

// (17, '0017', 'ขอทราบชื่อโรงพยาบาลที่คุณแม่ไปฝากครรภ์หน่อยค่ะ', NULL, 2, '0018', NULL, NULL),

// (18, '0018', 'ชื่อโรงพยาบาลที่คุณแม่ไปฝากครรภ์คือ', 'ใช่ไหมคะ ถ้าไม่ถูกต้องกรุณาพิมพ์ชื่อโรงพยาบาลของคุณใหม่ค่ะ', 3, '0019', NULL, NULL),

// (19, '0019', 'ขอทราบเลขประจำตัวผู้ป่วยของโรงพยาบาลที่คุณแม่ไปฝากครรภ์หน่อยค่ะ', NULL, 2, '0020', NULL, NULL),

// (20, '0020', 'เลขประจำตัวผู้ป่วยของโรงพยาบาลที่คุณแม่ไปฝากครรภ์คือ ', 'ใช่ไหมคะ ถ้าไม่ถูกต้องกรุณาพิมพ์เลขประจำตัวผู้ป่วยของคุณใหม่ค่ะ', 3, '0021', NULL, NULL),

// (21, '0021', 'คุณมีประวัติการแพ้ยาหรืออาหารไหมคะ', NULL, 2, '1001', NULL, NULL),
