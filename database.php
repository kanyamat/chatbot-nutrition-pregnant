...
(3, '0003', 'ก่อนอื่น ดิฉันขอทราบชื่อและนามสกุลของว่าที่คุณแม่หน่อยนะคะ', NULL, 2, '0004', NULL, NULL),

(4, '0004', 'ชื่อของคุณคือ', 'ใช่ไหมคะ? ถ้าไม่ถูกต้องกรุณาพิมพ์ชื่อของคุณใหม่อีกครั้งนะคะ', 3, '0005', NULL, NULL),

(5, '0005', 'ขอทราบอายุของคุณหน่อยค่ะ ', NULL, 2, '0006', NULL, NULL),

(6, '0006', 'คุณอายุ', 'ปี ใช่ไหมคะ ถ้าไม่ถูกต้องกรุณาพิมพ์อายุของคุณใหม่ค่ะ', 3, '0007', NULL, NULL),

(7, '0007', 'ขอทราบส่วนสูงปัจจุบันของคุณค่ะ (กรุณาตอบเป็นตัวเลขในหน่วยเซ็นติเมตร เช่น 160)', NULL, 2, '0008', NULL, NULL),

(8, '0008', 'ส่วนสูงปัจจุบันของคุณคือ', 'เซ็นติเมตร ใช่ไหมคะ ถ้าไม่ถูกต้องกรุณาพิมพ์ส่วนสูงของคุณใหม่ค่ะ', 3, '0009', NULL, NULL),

(9, '0009', 'ขอทราบน้ำหนักปกติก่อนตั้งครรภ์ค่ะ (กรุณาตอบเป็นตัวเลขในหน่วยกิโลกรัม เช่น 55)', NULL, 2, '0010', NULL, NULL),

(12, '0010', 'ก่อนตั้งครรภ์คุณมีน้ำหนัก', 'กิโลกรัมใช่ไหมคะ ถ้าไม่ถูกต้องกรุณาพิมพ์น้ำหนักก่อนตั้งครรภ์ของคุณใหม่ค่ะ', 3, '0011', NULL, NULL),

(13, '0011', 'ขอทราบครั้งสุดท้ายที่คุณมีประจำเดือนเพื่อคำนวณอายุครรภ์ค่ะ (กรุณาตอบวันที่และเดือนเป็นตัวเลขนะคะ เช่น 17 04 คือ วันที่ 17 เมษายน)', NULL, 2, '0012', NULL, NULL),

(14, '0012', 'คุณมีอายุครรภ์', 'ใช่ไหมคะ ถ้าไม่ถูกต้องกรุณาพิมพ์วันที่และเดือนครั้งสุดท้ายที่คุณมีประจำเดือนใหม่ค่ะ', 3, '0013', NULL, NULL),

(15, '0013', 'ขอทราบเบอร์โทรศัพท์ของคุณหน่อยค่ะ', NULL, 2, '0014', NULL, NULL),

(16, '0014', 'เบอร์โทรศัพท์ของคุณคือ', 'ใช่ไหมคะ ถ้าไม่ถูกต้องกรุณาพิมพ์เบอร์โทรศัพท์ของคุณใหม่ค่ะ', 3, '0015', NULL, NULL),

(17, '0015', 'ขอทราบชื่อโรงพยาบาลที่คุณแม่ไปฝากครรภ์หน่อยค่ะ', NULL, 2, '0016', NULL, NULL),

(18, '0016', 'ชื่อโรงพยาบาลที่คุณแม่ไปฝากครรภ์คือ', 'ใช่ไหมคะ ถ้าไม่ถูกต้องกรุณาพิมพ์ชื่อโรงพยาบาลของคุณใหม่ค่ะ', 3, '0017', NULL, NULL),

(19, '0017', 'ขอทราบเลขประจำตัวผู้ป่วยของโรงพยาบาลที่คุณแม่ไปฝากครรภ์หน่อยค่ะ', NULL, 2, '0018', NULL, NULL),

(20, '0018', 'เลขประจำตัวผู้ป่วยของโรงพยาบาลที่คุณแม่ไปฝากครรภ์คือ ', 'ใช่ไหมคะ ถ้าไม่ถูกต้องกรุณาพิมพ์เลขประจำตัวผู้ป่วยของคุณใหม่ค่ะ', 3, '0019', NULL, NULL),
